...
{
    [self showStatus:status view:nil];
}

+ (void)showStatus:(NSString *)status toView:(UIView *)view
{
    [self showStatus:status view:view];
}
...
+ (void)showStatus:(NSString *)status view:(UIView *)view
{
    [self dismissForView:view];
